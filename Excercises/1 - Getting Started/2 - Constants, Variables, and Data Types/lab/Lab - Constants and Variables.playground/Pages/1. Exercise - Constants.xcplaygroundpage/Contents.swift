 ...
 */
print("It doesn't compile because friends is declared as a constant variable, which makes sure the variable can't be changed after the first declaration.")
