...
let currentHR = 147
let isInTarget = currentHR < targetUpperBound && currentHR > targetLowerBound ? true : false
let isBelowTarget = currentHR < targetLowerBound ? true : false
let isAboveTarget = currentHR > targetUpperBound ? true : false
